...
func snake(names ...string) string {
	return snaker.CamelToSnake(strings.Replace(strings.Join(names, "_"), "tab_", "", -1))
}

func snakeExport(names ...string) string {
	return snaker.CamelToSnakeIdentifier(strings.Replace(strings.Join(names, "_"), "tab_", "", -1))
}

func camel(names ...string) string {
	return snaker.ForceLowerCamelIdentifier(strings.Replace(strings.Join(names, "_"), "tab_", "", -1))
}

func camelExport(names ...string) string {
	return snaker.ForceCamelIdentifier(strings.Replace(strings.Join(names, "_"), "tab_", "", -1))
}

func noCamelExport(names ...string) string {
	return (strings.Replace(strings.Join(names, "_"), "tab_", "", -1))
}
